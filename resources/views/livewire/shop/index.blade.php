<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-sm-12 col-xs-12 col-md-4 col-lg-3 mb-4">
            <div class="card h-80">
                <img class="card-img-top img-fluid" src="{{ $product->image ? asset('/storage/' . $product->image) : 'http://place-hold.it/150x150' }}" alt="">
                <div class="card-img-overlay" style="background-color: rgba(0,0,0,0.5);">
                    ...
                    <button wire:click="" type="button" class="btn btn-sm btn-block btn-outline-secondary text-white">Add to cart</button>
                </div>
            </div>
        </div>
        @endforeach
